  ...
  return <section className="py-20 md:py-28 relative overflow-hidden">
      ...
      <div className="minimal-container relative z-10">
        <div className="max-w-4xl mx-auto text-center space-y-12">
          ...
          <div className="luxury-card bg-black/50 backdrop-blur-lg p-12 space-y-8 animate-fade-in shadow-gold" style={{
          animationDelay: "0.2s"
        }}>
            ...
            <div className="flex flex-col space-y-8">
              ...
              <Button onClick={() => window.open('https://chk.eduzz.com/D0RAJJ719Y', '_blank', 'noopener,noreferrer')} className="mx-auto bg-gradient-gold hover:opacity-90 text-black font-medium tracking-wider rounded-sm transition-all duration-300 shadow-gold group text-xl py-[28px] px-[24px]">
                Acessar Sala VIP
